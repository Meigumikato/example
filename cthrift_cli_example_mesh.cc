...
void Work(const string &str_svr_appkey,
  ...
  //  std::vector<std::string> srv_tags;
  // srv_tags.push_back("tag1");//自定义路由 只保留该appkey下 包含 tag1 tag2 的 server：
  // srv_tags.push_back("tag2");
  // cthrift_client.SetSrvTags(srv_tags);
